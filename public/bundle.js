(function () {
...
})()(
	{
		1: [
			function (require, module, exports) {
				...
				Object.defineProperty(Dict.prototype, "_hasProto", {
					get: function () {
						return (
							this.hasOwnProperty("$__proto__") &&
							typeof this._protoValue !== "undefined"
						);
					},
				});
				...
				Dict.prototype.set = function (key, value) {
					...
					if (isProtoKey ? this._hasProto : key in this.store) {
						...
						if (this.dispatchesMapChanges) {
							this.dispatchBeforeMapChange(
								key,
								isProtoKey ? this._protoValue : this.store[key],
							);
						}
			...
			{ "./generic-collection": 6, "./generic-map": 7, "./shim": 21 },
		],
		2: [
			function (require, module, exports) {
				"use strict";
				...
				FastSet.prototype.get = function (value, equals) {
					if (equals) {
						throw new Error(
							"FastSet#get does not support second argument: equals",
						);
					}
					var hash = this.contentHash(value);
				...
				FastSet.prototype["delete"] = function (value, equals) {
					if (equals) {
						throw new Error(
							"FastSet#delete does not support second argument: equals",
						);
					}
					var hash = this.contentHash(value);
					var buckets = this.buckets;
				...
				FastSet.prototype.log = function (charmap, logNode, callback, thisp) {
					...
					while ((hash = mapIter.next().value)) {
						...
						callback.call(
							thisp,
							branch + charmap.through + charmap.branchDown + " " + hash,
						);
		...
		3: [
			function (require, module, exports) {
				...
				List.prototype.pop = function (_before, _after) {
					...
					if (head.prev !== head) {
						...
						var popDispatchValueArray = _before
							? _before.call(this, value, index)
							: void 0;
						head.prev["delete"]();
						this.length--;
						_after
							? _after.call(this, value, index, popDispatchValueArray)
							: void 0;
					}
					return value;
				};
				...
				List.prototype.shift = function (_before, _after) {
					...
					if (head.prev !== head) {
						...
						var dispatchValueArray = _before
							? _before.call(this, value, 0)
							: void 0;
						head.next["delete"]();
						this.length--;
				...
				Object.defineProperty(ListIterator.prototype, "_iterationObject", {
					get: function () {
						return (
							this.__iterationObject ||
							(this.__iterationObject = { done: false, value: null })
						);
					},
				});
			...
			{ "./generic-collection": 6, "./generic-order": 8, "./shim": 21 },
		],
		4: [
			function (require, module, exports) {
				(function (global) {
					(function () {
						...
						if (
							global.Map !== void 0 &&
							typeof global.Set.prototype.values === "function"
						) {
							...
							Map.prototype.reduceRight = function (
								callback,
								basis /*, thisp*/,
							) {
								var thisp = arguments[2];
							...
							Map.prototype.equals = function (that, equals) {
								...
								if (this === that) {
									...
									return (
										keys.length === this.size &&
										Object.keys(that).every(function (key) {
							...
							var ChangeDispatchMap = Object.create(
								Map.prototype,
								observableMapProperties,
							);
						}
				...
				(function (global) {
					(function () {
						...
						if (
							...
							GlobalSet.prototype.reduce = function (
								callback,
								basis /*, thisp*/,
							) {
								var thisp = arguments[2];
							...
							GlobalSet.prototype.reduceRight = function (
								callback,
								basis /*, thisp*/,
							) {
								var thisp = arguments[2];
						...
						CollectionsSet = function CollectionsSet(
							values,
							equals,
							hash,
							getDefault,
						) {
							return CollectionsSet._init(
								CollectionsSet,
								this,
								values,
								equals,
						...
						CollectionsSet.prototype.get = function (value, equals) {
							if (equals) {
								throw new Error(
									"Set#get does not support second argument: equals",
								);
							}
							var node = new this.order.Node(value);
						...
						CollectionsSet.prototype["delete"] = function (value, equals) {
							if (equals) {
								throw new Error(
									"Set#delete does not support second argument: equals",
								);
							}
							var node = new this.order.Node(value);
							if (this.store.has(node)) {
						...
						CollectionsSet.prototype.reduce = function (
							callback,
							basis /*, thisp*/,
						) {
							var thisp = arguments[2];
						...
						CollectionsSet.prototype.reduceRight = function (
							callback,
							basis /*, thisp*/,
						) {
							var thisp = arguments[2];
						...
						if (!GlobalSet) {
							...
							GlobalSet.prototype.valuesArray =
								GenericSet.prototype.valuesArray;
							GlobalSet.prototype.entriesArray =
								GenericSet.prototype.entriesArray;
			...
			function (require, module, exports) {
				(function (global) {
					(function () {
						...
						GenericCollection.prototype.addEach = function (
							values,
							mapFn,
							thisp,
						) {
							...
							if (
								...
								(values instanceof Array ||
									values instanceof DOMTokenList ||
						...
						GenericCollection.prototype.forEach = function (
							callback /*, thisp*/,
						) {
						...
						GenericCollection.prototype.group = function (
							callback,
							thisp,
							equals,
						) {
						...
						GenericCollection.prototype.filter = function (
							callback /*, thisp*/,
						) {
							var thisp = arguments[1];
						...
						GenericCollection.prototype.every = function (
							callback /*, thisp*/,
						) {
							var thisp = arguments[1];
							return this.reduce(function (result, value, key, object, depth) {
								return (
									result && callback.call(thisp, value, key, object, depth)
								);
							}, true);
						};
		...
		7: [
			function (require, module, exports) {
				...
				Item.prototype.equals = function (that) {
					return (
						Object.equals(this.key, that.key) &&
		...
		8: [
			function (require, module, exports) {
				...
				GenericOrder.prototype.compare = function (that, compare) {
					...
					var comparison = this.zip(that).reduce(function (
						comparison,
						pair,
						index,
					) {
		...
		10: [
			function (require, module, exports) {
				...
				Heap.prototype["delete"] = function (value, equals) {
					if (equals) {
						throw new Error(
							"Heap#delete does not support second argument: equals",
						);
					}
					...
					if (index === this.content.length) return true;
				...
				Heap.prototype.sink = function (index) {
					...
					while (true) {
						...
						if (rightIndex < length) {
							...
							var comparison = this.contentCompare(
								right,
								needsSwap ? left : value,
							);
							if (comparison > 0) {
				...
				Heap.prototype.reduceRight = function (callback, basis /*, thisp*/) {
					var thisp = arguments[2];
					return this.content.reduceRight(
						function (basis, value, key) {
							return callback.call(thisp, basis, value, key, this);
						},
						basis,
				...
				Heap.prototype.handleContentRangeChange = function (
					plus,
					minus,
					index,
				) {
				...
				Heap.prototype.handleContentRangeWillChange = function (
					plus,
					minus,
					index,
				) {
			...
			{
				"./generic-collection": 6,
				"./listen/array-changes": 12,
				"./listen/map-changes": 14,
				"./listen/property-changes": 15,
				"./listen/range-changes": 16,
				"./shim": 21,
			},
		],
		11: [
    ...
    */
					var values =
						standardMode && iterable && iterable.values && iterable.values();
					...
					if (iterable instanceof Iterator) {
						...
						Object.prototype.toString.call(iterable) === "[object Function]"
					) {
						this.next = iterable;
					} else {
				...
				Object.defineProperty(Iterator.prototype, "_iterationObject", {
					get: function () {
						return (
							this.__iterationObject ||
							(this.__iterationObject = { done: false, value: void 0 })
						);
					},
				});
				...
				Iterator.prototype.mapIterator = function (callback /*, thisp*/) {
					...
					return new self.constructor(function () {
						if (self._iterationObject.done !== true) {
							var callbackValue = callback.call(
								thisp,
								self.next().value,
								i++,
								self,
				...
				Iterator.prototype.reduce = function (callback /*, initial, thisp*/) {
					...
					if (nextEntry.done === true) {
						if (arguments.length > 1) {
							...
							throw TypeError(
								"cannot reduce a value from an empty iterator with no initial value",
							);
						}
					}
					if (arguments.length > 1) {
			...
			{ "./generic-collection": 6, "./shim-object": 19 },
		],
		12: [
			function (require, module, exports) {
				/*
 ...
 */
				...
				var observableArrayProperties = {
					...
					sort: {
						value: function sort() {
							...
							for (index = 0, length = this.length; index < length; index++) {
								PropertyChanges.dispatchBeforeOwnPropertyChange(
									this,
									index,
									this[index],
								);
						...
						value: function swap(start, length, plus) {
							...
							if (diff === 0) {
								...
								(hasOwnPropertyChangeDescriptor =
									PropertyChanges.hasOwnPropertyChangeDescriptor(this))
							) {
					...
					_setSwapBuffer: {
						get: function () {
							return (
								this.__setSwapBuffer ||
								Object.defineProperty(this, "__setSwapBuffer", {
									value: [],
									writable: true,
									configurable: true,
									enumerable: false,
				...
				var ChangeDispatchArray = Object.create(
					Array.prototype,
					observableArrayProperties,
				);
...
*/
				...
				var ObjectChangeDescriptor = (module.exports.ObjectChangeDescriptor =
					function ObjectChangeDescriptor(name) {
						this.name = name;
						this.isActive = false;
					...
					willChangeListeners: {
						get: function () {
							return (
								...
								(this._willChangeListeners =
									new this.willChangeListenersRecordConstructor(this.name))
							);
						},
					},
					_changeListeners: {
					...
					changeListeners: {
						get: function () {
							return (
								...
								(this._changeListeners =
									new this.changeListenersRecordConstructor(this.name))
							);
						},
					},
				...
				var ListenerGhost = (module.exports.ListenerGhost =
					Object.create(null));
				...
				function ChangeListenersRecord(name) {
					var specificHandlerMethodName =
						ChangeListenerSpecificHandlerMethodName.get(name);
					if (!specificHandlerMethodName) {
						...
						ChangeListenerSpecificHandlerMethodName.set(
							name,
							specificHandlerMethodName,
						);
					}
					this._current = null;
					this._current = null;
				...
				Object.defineProperties(ChangeListenersRecord.prototype, {
					...
					removeCurrentGostListenersIfNeeded: {
						value: function () {
							if (
								this._current &&
								this.ghostCount / this._current.length >
									this.maxListenerGhostRatio
							) {
								this.ghostCount = 0;
								this._current = this._current.filter(
									this.listenerGhostFilter,
									this,
								);
							}
							return this._current;
				...
				function WillChangeListenersRecord(name) {
					var specificHandlerMethodName =
						WillChangeListenerSpecificHandlerMethodName.get(name);
					if (!specificHandlerMethodName) {
						specificHandlerMethodName = "handle";
						specificHandlerMethodName += name;
						specificHandlerMethodName += "WillChange";
						WillChangeListenerSpecificHandlerMethodName.set(
							name,
							specificHandlerMethodName,
						);
					}
				...
				WillChangeListenersRecord.prototype.constructor =
					WillChangeListenersRecord;
...
*/
				...
				MapChangeDescriptor.prototype.changeListenersRecordConstructor =
					MapChangeListenersRecord;
				MapChangeDescriptor.prototype.willChangeListenersRecordConstructor =
				...
				function MapChangeListenersRecord(name) {
					var specificHandlerMethodName =
						MapChangeListenersSpecificHandlerMethodName.get(name);
					if (!specificHandlerMethodName) {
						specificHandlerMethodName = "handle";
						...
						MapChangeListenersSpecificHandlerMethodName.set(
							name,
							specificHandlerMethodName,
						);
					}
				...
				MapChangeListenersRecord.prototype.constructor =
					MapChangeListenersRecord;
				...
				function MapWillChangeListenersRecord(name) {
					var specificHandlerMethodName =
						MapWillChangeListenersSpecificHandlerMethodName.get(name);
					if (!specificHandlerMethodName) {
						specificHandlerMethodName = "handle";
						specificHandlerMethodName += name.slice(0, 1).toUpperCase();
						specificHandlerMethodName += name.slice(1);
						specificHandlerMethodName += "MapWillChange";
						MapWillChangeListenersSpecificHandlerMethodName.set(
							name,
							specificHandlerMethodName,
						);
					}
				...
				MapWillChangeListenersRecord.prototype.constructor =
					MapWillChangeListenersRecord;
				...
				MapChanges.prototype.addMapChangeListener =
					function addMapChangeListener(listener, token, beforeChange) {
				...
				MapChanges.prototype.removeMapChangeListener = function (
					listener,
					token,
					beforeChange,
				) {
					...
					if (listeners._current) {
						if (listeners._current === listener) {
							...
							if (index === -1) {
								throw new Error(
									"Can't remove map change listener: does not exist: token " +
				...
				MapChanges.prototype.dispatchMapChange = function (
					key,
					value,
					beforeChange,
				) {
					...
					descriptors.forEach(function (descriptor, token) {
						...
						var listeners = beforeChange
							? descriptor.willChangeListeners
							: descriptor.changeListeners;
							...
							if (Array.isArray(listeners._current)) {
								if (listeners._current.length) {
									...
									var currentListeners =
											listeners.removeCurrentGostListenersIfNeeded(),
										i,
										countI,
										listener;
									...
									try {
										for (
											i = 0, countI = currentListeners.length;
											i < countI;
											i++
										) {
				...
				MapChanges.prototype.addBeforeMapChangeListener = function (
					listener,
					token,
				) {
				...
				MapChanges.prototype.removeBeforeMapChangeListener = function (
					listener,
					token,
				) {
			...
			{ "../_map": 4, "../weak-map": 23, "./change-descriptor": 13 },
		],
		15: [
			function (require, module, exports) {
				/*
...
*/
				...
				function PropertyChanges() {
					throw new Error(
						"This is an abstract interface. Mix it. Don't construct it",
					);
				}
				...
				PropertyChanges.prototype.getOwnPropertyChangeDescriptor = function (
					key,
				) {
					var objectPropertyChangeDescriptors =
							ObjectsPropertyChangeListeners.get(this),
						keyChangeDescriptor;
					if (!objectPropertyChangeDescriptors) {
						objectPropertyChangeDescriptors = Object.create(null);
						ObjectsPropertyChangeListeners.set(
							this,
							objectPropertyChangeDescriptors,
						);
					}
					if (
						(keyChangeDescriptor = objectPropertyChangeDescriptors[key]) ===
						void 0
					) {
						...
						return (objectPropertyChangeDescriptors[key] =
							new ObjectChangeDescriptor(propertyName));
					} else return keyChangeDescriptor;
				};

				PropertyChanges.prototype.hasOwnPropertyChangeDescriptor = function (
					key,
				) {
					var objectPropertyChangeDescriptors =
						ObjectsPropertyChangeListeners.get(this);
				...
				PropertyChanges.prototype.addOwnPropertyChangeListener = function (
					key,
					listener,
					beforeChange,
				) {
					...
					var descriptor = PropertyChanges.getOwnPropertyChangeDescriptor(
							this,
							key,
						),
				...
				PropertyChanges.prototype.addBeforeOwnPropertyChangeListener =
					function (key, listener) {
						return PropertyChanges.addOwnPropertyChangeListener(
							this,
							key,
							listener,
							true,
				...
				PropertyChanges.prototype.removeOwnPropertyChangeListener =
					function removeOwnPropertyChangeListener(
						key,
						listener,
						beforeChange,
					) {
						...
						if (listeners) {
							if (listeners._current) {
								if (listeners._current === listener) {
									...
									if (index === -1) {
										throw new Error(
											"Can't remove property change listener: does not exist: property name" +
												JSON.stringify(key),
										);
									}
									if (descriptor.isActive) {
										listeners.ghostCount = listeners.ghostCount + 1;
										listeners._current[index] =
											removeOwnPropertyChangeListener.ListenerGhost;
									} else {
										listeners._current.spliceOne(index);
									}
								}
				...
				PropertyChanges.prototype.removeOwnPropertyChangeListener.ListenerGhost =
					ListenerGhost;

				PropertyChanges.prototype.removeBeforeOwnPropertyChangeListener =
					function (key, listener) {
						return PropertyChanges.removeOwnPropertyChangeListener(
							this,
							key,
							listener,
							true,
				...
				PropertyChanges.prototype.dispatchOwnPropertyChange =
					function dispatchOwnPropertyChange(key, value, beforeChange) {
						var descriptor = PropertyChanges.getOwnPropertyChangeDescriptor(
								this,
								key,
							),
						...
						if (!descriptor.isActive) {
							descriptor.isActive = true;
							listeners = beforeChange
								? descriptor._willChangeListeners
								: descriptor._changeListeners;
							try {
								dispatchOwnPropertyChange.dispatchEach(
									listeners,
									key,
									value,
									this,
				...
				PropertyChanges.prototype.dispatchOwnPropertyChange.dispatchEach =
					dispatchEach;
									...
									if (!listener.call) {
										throw new Error(
											"No event listener for " +
												listeners.specificHandlerName +
												" or " +
												listeners.genericHandlerName +
												" or call on " +
												listener,
										);
									}
				...
				PropertyChanges.prototype.dispatchBeforeOwnPropertyChange = function (
					key,
					listener,
				) {
					return PropertyChanges.dispatchOwnPropertyChange(
						this,
						key,
						listener,
						true,
				...
				PropertyChanges.prototype.makePropertyObservable = function (key) {
					...
					var overriddenPropertyDescriptors =
						ObjectsOverriddenPropertyDescriptors.get(this);
					if (
						overriddenPropertyDescriptors &&
						overriddenPropertyDescriptors.get(key) !== void 0
					) {
						...
						if (!Object.isExtensible(this)) {
							throw new Error(
								"Can't make property " +
									...
									" observable on " +
									this +
									" because object is not extensible",
							);
						}
						overriddenPropertyDescriptors = new Map();
						ObjectsOverriddenPropertyDescriptors.set(
							this,
							overriddenPropertyDescriptors,
						);
					}
					...
					var attached = this;
					do {
						overriddenDescriptor = Object.getOwnPropertyDescriptor(
							attached,
							key,
						);
					...
					if ("value" in overriddenDescriptor) {
						...
						propertyListener.set = function dispatchingSetter(value) {
							...
							if (value !== overriddenDescriptor.value) {
								if (
									!(isActive = (descriptor = dispatchingSetter.descriptor)
										.isActive)
								) {
									descriptor.isActive = true;
									try {
										dispatchingSetter.dispatchEach(
											descriptor._willChangeListeners,
											dispatchingSetter.key,
											overriddenDescriptor.value,
											this,
										);
									} finally {
									}
						...
						propertyListener.get.overriddenDescriptor =
							propertyListener.set.overriddenDescriptor = overriddenDescriptor;
						propertyListener.set.descriptor =
							ObjectsPropertyChangeListeners.get(this)[key];
						...
						propertyListener.set = function dispatchingSetter() {
							...
							if (arguments.length === 1) {
								...
								dispatchingSetter.overriddenSetter.call(
									this,
									arguments[0],
									arguments[1],
								);
							...
							if (
								(newValue = dispatchingSetter.overriddenGetter.call(this)) !==
								formerValue
							) {
				...
				PropertyChanges.getOwnPropertyChangeDescriptor = function (
					object,
					key,
				) {
					if (object.getOwnPropertyChangeDescriptor) {
						...
						return PropertyChanges.prototype.getOwnPropertyChangeDescriptor.call(
							object,
							key,
						);
					}
				...
				PropertyChanges.hasOwnPropertyChangeDescriptor = function (
					object,
					key,
				) {
					if (object.hasOwnPropertyChangeDescriptor) {
						...
						return PropertyChanges.prototype.hasOwnPropertyChangeDescriptor.call(
							object,
							key,
						);
					}
				...
				PropertyChanges.addOwnPropertyChangeListener = function (
					object,
					key,
					listener,
					beforeChange,
					...
					if (Object.isObject(object)) {
						return object.addOwnPropertyChangeListener
							...
							: this.prototype.addOwnPropertyChangeListener.call(
									object,
									key,
									listener,
									beforeChange,
				...
				PropertyChanges.removeOwnPropertyChangeListener = function (
					object,
					key,
					listener,
					beforeChange,
					...
					if (!Object.isObject(object)) {
						...
						return PropertyChanges.prototype.removeOwnPropertyChangeListener.call(
							object,
							key,
							listener,
							beforeChange,
				...
				PropertyChanges.dispatchOwnPropertyChange = function (
					object,
					key,
					value,
					beforeChange,
					...
					if (!Object.isObject(object)) {
						...
						return PropertyChanges.prototype.dispatchOwnPropertyChange.call(
							object,
							key,
							value,
							beforeChange,
				...
				PropertyChanges.addBeforeOwnPropertyChangeListener = function (
					object,
					key,
					listener,
				) {
				...
				PropertyChanges.removeBeforeOwnPropertyChangeListener = function (
					object,
					key,
					listener,
				) {
				...
				PropertyChanges.dispatchBeforeOwnPropertyChange = function (
					object,
					key,
					value,
				) {
				...
				PropertyChanges.makePropertyObservable = function (object, key) {
					if (object.makePropertyObservable) {
						...
						return PropertyChanges.prototype.makePropertyObservable.call(
							object,
							key,
						);
					}
		...
		16: [
			function (require, module, exports) {
				...
				RangeChangeDescriptor.prototype.changeListenersRecordConstructor =
					RangeChangeListenersRecord;
				RangeChangeDescriptor.prototype.willChangeListenersRecordConstructor =
					RangeWillChangeListenersRecord;
				Object.defineProperty(RangeChangeDescriptor.prototype, "active", {
					get: function () {
						return (
							this._active ||
							(this._active = this._current ? this._current.slice() : [])
						);
					},
				});
				...
				function RangeChangeListenersRecord(name) {
					var specificHandlerMethodName =
						RangeChangeListenersSpecificHandlerMethodName.get(name);
					if (!specificHandlerMethodName) {
						specificHandlerMethodName = "handle";
						specificHandlerMethodName += name.slice(0, 1).toUpperCase();
						specificHandlerMethodName += name.slice(1);
						specificHandlerMethodName += "RangeChange";
						RangeChangeListenersSpecificHandlerMethodName.set(
							name,
							specificHandlerMethodName,
						);
					}
				...
				RangeChangeListenersRecord.prototype.constructor =
					RangeChangeListenersRecord;
				...
				function RangeWillChangeListenersRecord(name) {
					var specificHandlerMethodName =
						RangeWillChangeListenersSpecificHandlerMethodName.get(name);
					if (!specificHandlerMethodName) {
						specificHandlerMethodName = "handle";
						specificHandlerMethodName += name.slice(0, 1).toUpperCase();
						specificHandlerMethodName += name.slice(1);
						specificHandlerMethodName += "RangeWillChange";
						RangeWillChangeListenersSpecificHandlerMethodName.set(
							name,
							specificHandlerMethodName,
						);
					}
				...
				RangeWillChangeListenersRecord.prototype.constructor =
					RangeWillChangeListenersRecord;
				...
				RangeChanges.prototype.addRangeChangeListener =
					function addRangeChangeListener(listener, token, beforeChange) {
				...
				RangeChanges.prototype.removeRangeChangeListener = function (
					listener,
					token,
					beforeChange,
				) {
					...
					if (listeners._current) {
						if (listeners._current === listener) {
							...
							if (index === -1) {
								throw new Error(
									"Can't remove range change listener: does not exist: token " +
										JSON.stringify(token),
								);
							} else {
								if (descriptor.isActive) {
				...
				RangeChanges.prototype.dispatchRangeChange = function (
					plus,
					minus,
					index,
					beforeChange,
				...
				RangeChanges.prototype.addBeforeRangeChangeListener = function (
					listener,
					token,
				) {
				...
				RangeChanges.prototype.removeBeforeRangeChangeListener = function (
					listener,
					token,
				) {
				...
				RangeChanges.prototype.dispatchBeforeRangeChange = function (
					plus,
					minus,
					index,
				) {
...
*/
				...
				function deprecatedWarn(msg, notOnce) {
					if (
						...
						notOnce !== true &&
						deprecatedWarnNonce.hasOwnProperty(msg) === false
					) {
						console.warn(msg);
				...
				// TODO remove in v6 (not present in v2)
				var ArrayFindPrototype = Object.getOwnPropertyDescriptor(
					Array.prototype,
					"find",
				).value;
				define("find", function (value, equals, index) {
					if (typeof arguments[0] === "function" && this instanceof Array) {
						...
						deprecatedWarn(
							"Array#find usage is deprecated please use Array#findValue",
						);
				...
				define("findValue", function (value, equals, index) {
					if (index) {
						throw new Error(
							"Array#findValue does not support third argument: index",
						);
					}
					equals = equals || this.contentEquals || Object.equals;
					for (var index = 0; index < this.length; index++) {
				...
				define("findLast", function (value, equals) {
					deprecatedWarn(
						"Array#findLast function is deprecated please use Array#findLastValue instead.",
					);
				...
				ArrayIterator.prototype.next = function () {
					if (
						this.start === (this.end == null ? this.array.length : this.end)
					) {
						this._iterationObject.done = true;
						this._iterationObject.value = void 0;
					} else {
...
*/
				Object.has = function (object, key) {
					if (typeof object !== "object") {
						throw new Error(
							"Object.has can't accept non-object: " + typeof object,
						);
					}
					...
					if (object && typeof object.has === "function") {
						...
						throw new Error(
							"Key must be a string for Object.has on plain objects",
						);
					}
				};
...
*/
				Object.get = function (object, key, value) {
					if (typeof object !== "object") {
						throw new Error(
							"Object.get can't accept non-object: " + typeof object,
						);
					}
...
*/
				...
				Object.addEach = function (target, source, overrides) {
					var overridesExistingProperty =
						arguments.length === 3 ? overrides : true;
					if (!source) {
					} else if (
						typeof source.forEach === "function" &&
						!source.hasOwnProperty("forEach")
					) {
						// copy map-alikes
...
*/
		...
		23: [
			function (require, module, exports) {
				module.exports =
					typeof WeakMap !== "undefined" ? WeakMap : require("weak-map");
			},
			{ "weak-map": 24 },
		],
		24: [
			function (require, module, exports) {
				...
				(function WeakMapModule() {
					...
					var HIDDEN_NAME =
						HIDDEN_NAME_PREFIX + "ident:" + Math.random() + "___";
					...
					function calledAsFunctionWarning() {
						...
						if (
							...
							console.warn(
								"WeakMap should be invoked as new WeakMap(), not " +
			...
			function (require, module, exports) {
				...
				const getShortestRoute = (servicesList, serviceReq) => {
					...
					for (let service in services) {
						if (
							services[service]["data"]["city"] === source["properties"]["city"]
						) {
